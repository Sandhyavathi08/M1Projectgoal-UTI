...
void add_student(){
    ...
    if(fp == NULL){
        ...
        fflush(stdin);
        gotoxy(print,10);printf("Roll No: ");gets(stu.rollno);
...
void search_student(){
    ...
    if(isFound == 1){
        ...
        gotoxy(37,14);printf("Roll No: %s",stu.rollno);
...
void mod_student(){
    ...
    while(fread(&stu, sizeof(stu),1,fp) == 1){
        if(strcmp(s_id, stu.rollno) == 0){
            fflush(stdin);
            gotoxy(print,12);printf("Roll No: ");gets(stu.rollno);
...
void delete_student(){
    ...
    while(fread(&stu, sizeof(stu),1,fp) == 1){
        if(strcmp(s_rollno, stu.rollno) == 0){
